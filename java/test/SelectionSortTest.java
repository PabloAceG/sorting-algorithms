...
class SelectionSortTest {
	...
	void testAscendingOrderSortedIntegers() {
		...
		array = ss.<Integer>sort(array, Order.ASC);
	...
	void testDescendingOrderSortedIntegers() {
		...
		SelectionSort<Integer> ss = new SelectionSort<Integer>();
		array = ss.<Integer>sort(array, Order.DESC);
	...
	void testAscendingOrderUnsortedFloats() {
		...
		SelectionSort<Float> ss = new SelectionSort<Float>();
		array = ss.<Float>sort(array, Order.ASC);
	...
	void testDescendingOrderUnsortedFloats() {
		...
		SelectionSort<Float> ss = new SelectionSort<Float>();
		array = ss.<Float>sort(array, Order.DESC);
	...
	void testAscendingOrderUnsortedChar() {
		...
		SelectionSort<Character> ss = new SelectionSort<Character>();
		array = ss.<Character>sort(array, Order.ASC);
	...
	void testDescendingOrderUnsortedChar() {
		...
		SelectionSort<Float> ss = new SelectionSort<Float>();
		array = ss.<Character>sort(array, Order.DESC);
	...
	void testAscendingOrderUnsortedString() {
		...
		array = ss.<String>sort(array, Order.ASC);
	...
	void testDescendingOrderUnsortedString() {
		...
		SelectionSort<String> ss = new SelectionSort<String>();
		array = ss.<String>sort(array, Order.DESC);
	...
	void testEmptyArray() {
		...
		assertArrayEquals(ordered, ss.sort(array, Order.ASC));
		assertArrayEquals(ordered, ss.sort(array, Order.DESC));
	}
